<table class="table wp-list-table widefat fixed striped posts">
										...
										<tbody>
													...
													if($wpdb->get_var("SHOW TABLES LIKE '$table'") == $table) {
														$query = "";
														$query = "SELECT * from $table WHERE status='pending' ORDER BY main_id DESC";
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <form class="wp-core-ui" method="post">
                                                                        <input type="submit" name="delete_invoicee" class="button action" value="<?php echo esc_html__('Delete', 'listingpro-plugin'); ?>" onclick="return window.confirm('Are you sure you want to proceed action?');" />
