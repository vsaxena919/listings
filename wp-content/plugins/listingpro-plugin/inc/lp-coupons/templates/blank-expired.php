<table class="table wp-list-table widefat fixed striped posts">
											...
											<tr>
												...
												<td id="cb3" class="manage-column column-cb check-column"><label class="screen-reader-text" for="cb-select-all-1">Select All</label><input id="cb-select-all-1" type="checkbox"></td>


													<th scope="col" id="title3" class="manage-column column-title column-primary sortable desc">
											...
											<tbody>
												<tr class="no-items">
													<td class="colspanchange" colspan="9">
														<?php echo esc_html__('Sorry! There is no expired coupon', 'listingpro-plugin'); ?>
													</td>
												</tr>
											</tbody><tfoot>
												<tr>
													<td class="manage-column column-cb check-column"><label class="screen-reader-text" for="cb-select-all-4">Select All</label><input id="cb-select-all-4" type="checkbox"></td>
