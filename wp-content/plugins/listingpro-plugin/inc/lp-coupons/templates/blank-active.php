<table class="table wp-list-table widefat fixed striped posts">
											...
											<tr>
												...
												<td id="cb2" class="manage-column column-cb check-column"><label class="screen-reader-text" for="cb-select-all-2">Select All</label><input id="cb-select-all-2" type="checkbox"></td>


													<th scope="col" id="title2" class="manage-column column-title column-primary sortable desc">
											...
											<tbody>
												<tr class="no-items">
													<td class="colspanchange" colspan="9">
														<?php echo esc_html__('Sorry! There is no active coupon', 'listingpro-plugin'); ?>
													</td>
												</tr>
											</tbody><tfoot>
												<tr>
													<td class="manage-column column-cb check-column"><label class="screen-reader-text" for="cb-select-all-3">Select All</label><input id="cb-select-all-3" type="checkbox"></td>
