<?php
	...
	/* vertical view code */
								...
								if( !empty($plan_type) && $plan_type=="Package" ){
									...
									<div class="'.$classForBg.'" style="'.$plan_title_bg.'">
										...
										<div class="lp-plane-top-wrape lp_plan_image_heading_v3">
											...
											<a id="lp_plan_heading_v3">'.get_the_title().'</a>';
							...
							<div class="lp-view-all-price-feature"><span class="lp-hide-show-price-features '.$lpviewallpricefeature.'" style="'.$left.'">View All Features</span></div>
