...
<?php
	...
	/* vertical view code */
							...
							<div class="col-md-4 '.get_the_ID().' '.$hotClass.' pricing_plans_v2 pricing_plans_v5">
							<div class="view_version_2">
									...
									<div class="'.$classForBg.'" style="'.$plan_title_bg.'">
										...
										$output1 .='	</div>';
											...
											if(!empty($perMonthPrce)){
													$output1 .="<span>".esc_html__('Per Month Price : ', 'listingpro-plugin').$perMonthPrce."</span>";
