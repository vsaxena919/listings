...
class Listing_With_Coupons extends Widget_Base {

    public function get_name() {
        return 'listing-with-coupons';
    }

    public function get_title() {
        return __( 'Listings With Coupons', 'elementor-listingpro' );
    }
    ...
    protected function render() {
        ...
        echo listingpro_shortcode_listing_grids_with_coupons( $settings );
    }
    protected function content_template() {}
    public function render_plain_content() {}
}
if(!function_exists('listingpro_shortcode_listing_grids_with_coupons')) {
