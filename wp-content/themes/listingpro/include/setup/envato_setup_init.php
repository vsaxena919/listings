				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'listingpro' ),
							'description' => __( 'Upgrade Content and Settings', 'listingpro' ),
							'pending' => __( 'Pending.', 'listingpro' ),
							'installing' => __( 'Installing Updates.', 'listingpro' ),
							'success' => __( 'Success.', 'listingpro' ),
